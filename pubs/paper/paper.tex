...
% Equation boxes:
% --
\usepackage{empheq} %visual markup extension to amsmath.
\definecolor{bocolor}{rgb}{1.0, 0.98, 0.98}
...
\author{Jonathan Prieto-Cubides\inst{1}\,\inst{2}
\and Andr\'es Sicard-Ram\'irez\inst{1}
}
%

\institute{Universidad EAFIT, Medell\'in, Colombia\\
\email{asr@eafit.edu.co}
\and
...
% \tableofcontents
\subfile{sections/02-introduction.tex}
\subfile{sections/03-type-theory.tex}
\subfile{sections/04-metis-language-and-proofs.tex}
\subfile{sections/05-proof-reconstruction.tex}
\subfile{sections/06-related-work.tex}
\subfile{sections/07-conclusions-and-future-work.tex}
\subfile{sections/08-acknowledgements.tex}

\printbibliography
\addcontentsline{toc}{section}{References}

% \newpage
\subfile{sections/09-appendices.tex}
