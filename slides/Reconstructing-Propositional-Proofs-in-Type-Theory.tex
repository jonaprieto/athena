...
data Prop : Set where
  ...
  ¬_  : (φ : Prop)   → Prop
\end{MyAgda}
\item Intuitionistic Propositional Logic + PEM ($\Gamma ⊢ \varphi \vee \neg \varphi$)
\end{itemize}
\end{frame}
...
\begin{frame}[fragile]{Syntactical Consequence Relation}
\begin{itemize}
...
\end{MyAgda}
  ...
  \item Natural deduction proofs for more than 99 theorems
