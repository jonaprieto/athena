...
\newcommand{\gobackreconstruction}{
  \begin{tikzpicture}[overlay, remember picture, scale=0.5]
    ...
    \node[fill=blu,text=white, hyperlink node = reconstruction]
...
% Color definitions.
% --------------------------------------------------------------------------
\usepackage{xcolor}\definecolor{blu}{RGB}{1,0,102}
\definecolor{blu}{RGB}{1,0,102}
\definecolor{decoration}{RGB}{10,164,216}
...
\subtitle{Advisor: Andr\'es Sicard-Ram\'irez}
\date{\today}
...
equality developed by~\cite{hurd2003first}. For the propositional
fragment, \Metis has only three inference rules:
