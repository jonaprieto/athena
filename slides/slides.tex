...
\begin{block}{Why Metis?}
  \begin{itemize}
    ...
    \item Each refutation step is one of
      \href{http://www.gilith.com/software/metis/logical-kernel.txt}{\textit{6 rules}}
...
\begin{frame}[fragile, label=failure-example]{Bug in the Printing of the Proof}
  {\texttt{Metis}' Issue: \url{https://github.com/gilith/metis/issues/2}}
% {}
% \begin{tptp}
% $ cat problem.tptp
% fof(goal, conjecture,
...
\begin{frame}[fragile]{Related Work: \texttt{Apia}}
  {Proving First-Order theorems written in \texttt{Agda} using automatic theorem provers for First-Order Logic}
...
\begin{frame}[label=references, allowframebreaks]{References}
\printbibliography
\end{frame}
