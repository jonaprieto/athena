...
\begin{itemize}
    \item Parsing of \texttt{TSTP} language
...
\only<7->{ \node[left= 2.75cm of atp, rectangle, text=white,fill=black, align=left, font=\tiny] (proved)
{
\texttt{\$ agda Or.agda}\\
...
\hline
\href{http://github.com/jonaprieto/agda-prop}{\texttt{Agda-Prop}}     & lib. for syntax and theorems of Clasical Propositional Logic\\
\href{http://github.com/jonaprieto/agda-metis}{\texttt{Agda-Metis}}   & lib. for versions of the inference rules used by \texttt{Metis}\\
\href{http://github.com/jonaprieto/athena}{\texttt{Athena}}           & soft. Translator in Haskell for \texttt{Metis'} \texttt{TSTP} files to \texttt{Agda}\\
\href{http://github.com/jonaprieto/online-atps}{\texttt{OnlineATPs}}  & soft. A client in Haskell for \texttt{SystemOnTPTP} of \texttt{TPTP} World\\[1ex]
\hline
\end{tabular}}
}
\end{center}
