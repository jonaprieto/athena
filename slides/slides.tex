...
\begin{frame}[fragile, label=atp-conjunct]{Conjunct}{Metis Inference Rule}
...
\item Function\footnote{\label{note-conjunct}It is available in \texttt{agda-metis} library in \texttt{ATP.Metis.Rules.Conjunct} module.}:
\begin{agda}
...
% \begin{frame}[fragile, label=verified-example1]{TPTP}
