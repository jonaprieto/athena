...
\spnewtheorem{mainlemma}{Lemma}{\bfseries}{\rmfamily}
...
\spnewtheorem{mydefinition}{Definition}{\bfseries}{\rmfamily}
\spnewtheorem{myexamplenum}{Example}{\bfseries}{\rmfamily}
