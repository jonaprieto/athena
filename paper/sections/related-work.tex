...
Kanso and Setzer~\cite{kanso2016light} integrate the propositional fragment of \name{EProver} in \Agda. In this work, the authors translate automatically propositional logic problems written in \Agda to \TPTP problems. By calling an external wrapper of the ATP, this tool gets a \TSTP derivation. The tool parses the \name{EProver} derivation and outputs
