...
\name{Isabelle} for higher-order logic. Sultana, Benzm{\"{u}}ller,
and Paulson~\cite{Een2004} integrates \name{Leo-II} and
...
\name{Coq} proof assistant \cite{coqteam} which provides a certified checker for proof witness coming from the \SMT solver \name{veriT}
\cite{bouton2009} and adds a new tactic named verit, that calls
\name{veriT} on any \name{Coq} goal. In \cite{bezem2002automated},
...
\cite{foster2011integrating} integrate \name{Waldmeister} into \Agda
