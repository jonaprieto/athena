...
\end{tikzpicture}
\caption{Proof-reconstruction overview. The rectangles nodes represent a file involved in the process. Between two nodes, we find direct edges that represent calls to programs. The programs here involved process an input file and reply always an output file.}
