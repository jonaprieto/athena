...
\end{tikzpicture}
\caption{Proof-reconstruction overview. The rectangles or rhombuses nodes represent a file involved in the process. Between two nodes, we find direct edges that represent calls to programs where the input file is pointed by the edge entering and the out edge points to the reply file.}
