...
We refer to $\fstrip$ as the function after applying the process mentioned above here and below unless otherwise stated.

\begin{lemma}[lem-inv-strip] $Γ ⊢ \fstrip(φ)$ then $Γ ⊢ φ$.
