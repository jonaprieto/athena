...
For this inference rule, we the \rm{conjunct} function in~(\ref{def:conjunct}) and we proved Theorem~\ref{thm:thm-conjunct}. The pattern is the following for
