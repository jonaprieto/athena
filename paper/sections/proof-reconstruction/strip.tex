...
In (\ref{eq:strip-example}), by proving each subgoal from left to right in the right conjunction,
we get a proof for the conjecture by using the elimination of the implication .
\end{myexample}
