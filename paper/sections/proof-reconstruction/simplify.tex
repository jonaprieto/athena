...
\emph{disjunctive syllogism}) to get a contradiction in the first place, or a a
new formula to use later.
...
Otherwise, the \fsimplify rule performs  in~\eqref{eq:simplify-2} an analysis by following the cases to determine which theorem should it applies.
