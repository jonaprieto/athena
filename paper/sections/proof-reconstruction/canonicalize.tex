...
% The functions defined above remove all kind of redundancies but they were
% defined to act in a certain kind of formula, \ie a disjunction or a
% conjunction. To remove all kind of redundancies listed above we defined
