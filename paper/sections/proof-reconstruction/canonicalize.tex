...
The rule jointly with the \clausify rule perform the so-called
\emph{clausification} process mainly described
in~\cite{Sutcliffe1996}.

The \canonicalize rule removes inside of the formula redundancies
(tautologies or definitions) listed in~Fig.~\ref{fig:redundancies}.
