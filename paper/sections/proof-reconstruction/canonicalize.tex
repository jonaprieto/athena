...
To remove redundancies in Fig~\ref{fig:or-redundancies} we
apply Lemma~\ref{lem:canon-or}.
...
To remove the two first cases in Fig.~\ref{fig:or-redundancies}
inside the formula, we apply the $\fndisj_{∨}$ function.
...
In right-associative conjunctions we remove the following redundancies
