...
simplifications by applying to it the $\fnnf_{1}$ function defined
...
as we describe in Section~\ref{ssec:structural-recursion}.
...
\begin{mainlemma}
  ...
  \begin{align*}
   ...
   \end{split}
  \end{align*}
  and the $\fnnf_{cm}$ function, the complexity measure function
  defined in Appendix~\ref{app:polarity-for-propositions}.
\end{mainlemma}
