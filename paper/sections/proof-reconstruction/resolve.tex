...
is not presented here, but is defined in a similar way (see its definition
in~\cite{AgdaMetis}).
...
\begin{mainlemma}[lem-build$_{\boldsymbol{∨}}$]
...
\begin{mainlemma}[lem-sbuild$_{\boldsymbol{∨}}$]
...
\begin{mainlemma}[lem-reorder$_{\boldsymbol{∧}}$]
...
\begin{mainlemma}[lem-conjunct$_{\boldsymbol{∨}}$]
