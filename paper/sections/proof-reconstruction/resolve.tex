...
We define the $\fsbuild_{∨}$ function in~\eqref{eq:strong-build-or}
...
This purpose of this function consists of extract a disjunction from
a conjunction, but without matter the order atoms in the disjunction.
