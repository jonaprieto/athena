...
\Metis is an automatic theorem prover written in \len{ML} for
first-order logic with equality developed by
\citeauthor{hurd2003first}~\cite{hurd2003first}. This prover is
...
inference rules. In Fig.~\ref{fig:metis-inferences}, we show the three
\Metis rules for propositional logic.
...
\caption{\Metis inference rules.}
  ...
  {\renewcommand{\arraystretch}{1.6}%
    ...
    \begin{tabular}{|@{\hspace{2mm}}c@{\hspace{2mm}}l@{\hspace{3mm}}l@{\hspace{3mm}}|}
    \hline
    \textbf{Theorem} & \textbf{Purpose} &\textbf{\Metis rule}\\ \hline
