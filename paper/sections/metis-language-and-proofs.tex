...
A \verb!fof! problem contains the conjecture also named the \emph{goal} in the
...
they tend to be less complex or even smaller propositions. At the end, the
...
Finally, \emph{axiom} rule appears in \TSTP derivation by one of the following
rules to in the problem a \verb!fof! axiom: \canonicalize, \clausify,
\conjunct, or \simplify. Then, the last rule remains is \emph{resolve}, it
